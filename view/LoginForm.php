...
<div id="form-container">
    <form action="#" method="post" id="login-form">
        ...
        <div class="toggle-password-view toggle-password-view-login">
        ...
        <button type="submit" class="register-button general-button">ACCEDI</button>

        <section id="have-account">
            <label>Non hai ancora un profilo?</label>&nbsp;<a href="#" id="login-link">Registrati</a>
        </section>
    </form>
</div>
<!-- form end -->