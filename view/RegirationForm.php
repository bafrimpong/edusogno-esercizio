...
<div id="form-container">
    <form action="#" method="post" id="registration-form">
        ...
        <div class="toggle-password-view toggle-password-view-registration">
        ...
        <button type="submit" class="register-button general-button">REGISTRATI</button>

        <section id="have-account">
            <label>Hai già un account?</label>&nbsp;<a href="#" id="login-link">Accedi</a>
        </section>
    </form>
</div>
<!-- form end -->